<?php
    ...
    $sql = "SELECT cadastrar_eventos.nome, cadastrar_eventos.avatar, cadastrar_eventos.whatsapp, 
                   cadastrar_eventos.descricao, cadastrar_eventos.local, cadastrar_eventos.vagas, 
                   cadastrar_eventos.custo, cadastrar_eventos.data, cadastrar_eventos.hora
            FROM cadastrar_eventos 
            INNER JOIN eventos_usuarios ON cadastrar_eventos.id = eventos_usuarios.id_cadastrar_eventos
            INNER JOIN cadastrar_usuarios ON eventos_usuarios.id_cadastrar_usuarios = cadastrar_usuarios.id
            WHERE cadastrar_usuarios.id = '$id_usuario'";
